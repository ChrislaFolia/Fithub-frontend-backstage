                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody class="align-middle text-center">
                                <tr v-for="(Activity, activityindex) in Activitys" :key="activityindex">
                                    <td><input type="checkbox" v-model="selectedActivities" :value="Activity.activityid"></td> 
                                    <td>{{ Activity.activityname }}</td>
                                    <td>{{ Activity.activitydescription }}</td>
                                    <td>{{ Activity.classroomDescription }}</td>
                                    <td>{{ Activity.activitydate }}</td>
                                    <td>{{ Activity.activityurl }}</td>
                                    <td>{{ Activity.activityurl }}</td>
                                    <td>{{ Activity.activityurl }}</td>
                                    <td><img :src="Activity.classroomPic" style="width: 150px;height: 150px;" alt="維修中"></td>
