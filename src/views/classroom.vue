                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody class="align-middle text-center">
                                    <tr v-for="(classroom, classroomindex) in classrooms" :key="classroomindex">
                                        <td><input type="checkbox" v-model="selectedClassrooms"
                                        ...
                                        <td><img :src="classroom.classroomPic" style="width: 150px;height: 150px;"
                                                alt="維修中">
                                        </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            設備介紹<input v-model="updateSelectedClassroom.classroomDescription" type="text"
                                class="form-control">
